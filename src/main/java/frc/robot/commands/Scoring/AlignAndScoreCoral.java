...
public class AlignAndScoreCoral extends SequentialCommandGroup {
  ...
  public AlignAndScoreCoral(Drivetrain drivetrain, Elevator elevator, EndEffector endEffector) {
    ...
    CoralPositionAlignCommand coralPositionAlign = new CoralPositionAlignCommand(
      drivetrain, 
      position, 
      EndEffector.getCoralLevel() == Level.LEVEL4 ? Constants.kDrivetrain.L4_X_DISTANCE_TO_REEF : Constants.kDrivetrain.NON_L4_X_DISTANCE_TO_REEF);
    ConditionalCommand autoMoveToLevel = new ConditionalCommand(
