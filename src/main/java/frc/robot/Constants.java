...
public final class Constants {
  ...
  public final class kDrivetrain {
    ...
    public static final double WHEEL_BASE = Units.inchesToMeters(23.729);
    ...
    public static final int DRIVE_VELOCITY_PERIOD_MS= 100;
    public static final int DRIVE_POSITION_PERIOD_MS= 100;
    ...
    /* Absolute Encoder Invert */
    public static final SensorDirectionValue ABSOLUTE_ENCODER_INVERT = SensorDirectionValue.CounterClockwise_Positive; //TODO: Determine whether to invert
